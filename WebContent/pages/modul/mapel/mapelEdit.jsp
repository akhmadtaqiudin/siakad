	...
	<div class="container-fluid">
		<div class="row">			
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	          <h3 class="page-header">Ubah Data Pelajaran</h3>	
	          <div class="errors">
				 <s:fielderror name="invalidguru"/>
			  </div>
				<s:form namespace="/mapel" method="POST" theme="bootstrap" cssClass="form-horizontal">
				  	<s:textfield name="mapel.kodeMapel" label="Kode Pelajaran " labelSeparator=":" readonly="true"/>
				  	...
				  	<div class="footer">
						...
						<s:submit action="SaveEditMapel" value="Edit" cssClass="btn btn-primary"/>
					</div>
				</s:form>
		    </div>      
        	</div>
