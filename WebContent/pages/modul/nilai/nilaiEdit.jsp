	...
	<div class="container-fluid">
		<div class="row">			
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	          <h3 class="page-header">Ubah Data Nilai Siswa</h3>	
				...
				<s:form namespace="/nilai" method="POST" theme="bootstrap" cssClass="form-horizontal">
					<s:textfield name="nilai.kodeNilai" label="Kode Nilai " labelSeparator=":" readonly="true"/>
					...
					<s:select list="#mp.listMapel" listKey="namaMapel" listValue="namaMapel" headerKey="0" 
				  	...
				  	<div class="footer">
						...
						<s:submit action="SaveEditNilai" value="Save" cssClass="btn btn-primary"/>
					</div>
				</s:form>
		    </div>      
        	</div>
