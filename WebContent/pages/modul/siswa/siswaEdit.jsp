	...
	<div class="container-fluid">
		<div class="row">			
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	          <h3 class="page-header">Ubah Data Siswa</h3>	
	          <s:form namespace="/siswa" method="POST" theme="bootstrap" cssClass="form-horizontal">
				  	<s:textfield name="siswa.nis" label="NIS " labelSeparator=":" readonly="true"/>
				  	...
				  	<div class="footer">
						...
						<s:submit action="SaveEditSiswa" value="Edit" cssClass="btn btn-primary"/>
					</div>
				</s:form>
		    </div>      
        	</div>
